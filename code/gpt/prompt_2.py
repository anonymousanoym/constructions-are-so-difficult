...
def generate_prompt_2(data, ignore_cache=False, model="gpt-3.5-turbo"):
    # creat the prompt
    user_prompt_list = []
    ...
    file_path = f"{fold}/result_2.json"
...
if __name__ == "__main__":
    ...
    generate_prompt_2(data, ignore_cache=True, model="gpt-3.5-turbo")
    generate_prompt_2(data, ignore_cache=True, model="gpt-4-0613")
