...
def generate_prompt_15(data, ignore_cache=False, model="gpt-3.5-turbo"):
    user_prompt_list = []
    for index, row in data.iterrows():
        premise = replace_parentheses(row["sentence"])
        text = add_not(premise, row["adjective"])
    ...
    file_path = f"{fold}/result_15.json"
...
if __name__ == "__main__":
    ...
    generate_prompt_15(data, ignore_cache=True, model="gpt-3.5-turbo")
    generate_prompt_15(data, ignore_cache=True, model="gpt-4-0613")
