...
def generate_prompt_10(data, ignore_cache=False, model="gpt-3.5-turbo"):
    user_prompt_list = []
    ...
    gold_dict = {"causal excess": "no", "causal": "yes", "non-causal": "no", "only causal excess": "no"}
    ...
    file_path = f"{fold}/result_10.json"
...
if __name__ == "__main__":
    ...
    generate_prompt_10(data, ignore_cache=True, model="gpt-3.5-turbo")
    generate_prompt_10(data, ignore_cache=True, model="gpt-4-0613")
