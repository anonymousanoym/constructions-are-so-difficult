...
def generate_prompt_8(data, ignore_cache=False, model="gpt-3.5-turbo"):
    user_prompt_list = []
    ...
    gold_dict = {"causal excess": "yes", "causal": "yes", "non-causal": "no", "only causal excess": "yes"}
    ...
    file_path = f"{fold}/result_8.json"

    # Write the JSON data to the filex
...
if __name__ == "__main__":
    ...
    generate_prompt_8(data, ignore_cache=True, model="gpt-3.5-turbo")
    generate_prompt_8(data, ignore_cache=True, model="gpt-4-0613")
