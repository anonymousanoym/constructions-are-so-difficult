...
def generate_prompt_7(data, ignore_cache=False, model="gpt-3.5-turbo"):
    user_prompt_list = []
    ...
    file_path = f"{fold}/result_7.json"
...
if __name__ == "__main__":
    ...
    generate_prompt_7(data, ignore_cache=True, model="gpt-3.5-turbo")
    generate_prompt_7(data, ignore_cache=True, model="gpt-4-0613")
